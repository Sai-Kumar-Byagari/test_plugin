...
#define TEST_PLUGIN(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), test_plugin_get_type(), \
                              TestPlugin))
...
static void test_plugin_handle_method_call(
    TestPlugin* self,
...
void test_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
  TestPlugin* plugin = TEST_PLUGIN(
      g_object_new(test_plugin_get_type(), nullptr));
